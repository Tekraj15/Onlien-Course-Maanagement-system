...
$num=mysqli_fetch_array($result) or die();
    if($num>0)
    {
...
header("location:http://localhost/onlinecourse/index.php");
exit();
}
}
?>
            ...
            <div class="row">
                <div class="col-md-6">
                     <label>Enter Reg no : </label>
                        ...
                        <span class="glyphicon glyphicon-user"></span> &nbsp;Log Me In </button>&nbsp;
                        <br><br>
                        <div id="submenu">
			<a href="signup.php">Sign Up</a>
		</div>
                        <!-- Not Registered ? <br> <button type="submit" name="submit1" class="btn btn-info" onClick=header("Location: http://localhost/onlinecourse/signup.php");>
